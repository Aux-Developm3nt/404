// api/script.js - REPLACE YOUR CURRENT FILE
...
spawn(function() 
  ...
  if (!captchaVerified) {
    ...
    return res.redirect('/captcha?redirect=' + encodeURIComponent(req.url));
  }
  
  // CAPTCHA verified - show 404 (keep your current style)
